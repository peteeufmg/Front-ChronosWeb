    ...
    return (
      <>
        <Container>
            ...
            <SelectContainer>
              ...
              <StyledList
                ...
                renderItem={(item, index) => (
                  <List.Item actions={[
                    <Flex wrap gap='large'>
                      <Button type='link' onClick={() => {setShowModal(!showModal); setSelectedTeam(item);}} icon={
                      ...
                      <Button type='link' onClick={() => {setShowModalE(!showModalE);setSelectedTeam(item);}} icon={             
          ...
          {showModal && <Modal onClickClose={closeModal} team={selectedTeam}/>}
          {showModalE && <ModalEditar onClickClose={closeModalE} team={selectedTeam}/>}
       </Container>
      </>
    )
}
